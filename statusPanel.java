...
public class statusPanel extends JPanel {
    ...
    public void initializePanel() {
        ...
        table.setModel(new DefaultTableModel(
            new Object[][] {},
            new String[] {
                "Item no", "Category", "Description","Status"
            }
        ) {
            private static final long serialVersionUID = 1L;
    ...
    private void loadTableData() {
        String sql = "SELECT id, category,complaint FROM item_complaint";
        ...
        try (Connection conn = parentFrame.connectDB();
            ...
            while (rs.next()) {
                ...
                String description = rs.getString("complaint"); // Assuming you have a description column
