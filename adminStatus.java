    ...
    private void loadTableData() {
        ...
        try (Connection conn = parentFrame.connectDB();
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{id, category, status, action});
            }
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try (Connection conn = parentFrame.connectDB();
                    		 PreparedStatement pstmt = conn.prepareStatement(
                                     "INSERT INTO item_history (id, category, isFound) VALUES (?, ?, ?)")) {
                                pstmt.setInt(1, id);
                                pstmt.setString(2, category);
                                pstmt.setBoolean(3, isFound); // This will insert 1/0 as required
                                pstmt.executeUpdate();
